<template>
	<div class="d-flex flex-column justify-content-center align-items-center">
		<img class="img-fluid" src="https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fimg1.wikia.nocookie.net%2F__cb20130927133418%2Fpokemon%2Ffr%2Fimages%2F1%2F1b%2FPokedex_logo.png&f=1&nofb=1"><img>
		<div class="d-flex flex-column justify-content-center align-items-center">
			<label for="fname">Pokémon:</label>
			<input type="text" id="fname" name="fname" v-on:keydown.enter="get()"><br><br>
		</div>
	</div>
	<div id="body" class="d-flex flex-row w-100 min-vh-100 parent">
		<div id="pokedex">
			<div id="left">
				<div id="logo"></div>
				...
				<div id="picture">
					<img v-bind:src="pokeImg" height="170" />
				</div>
			...
			<div id="right">
				<div id="stats">
				<strong>Name:</strong> <label class="text-capitalize">{{pokeName}}</label><br/>
				<strong>Type:</strong> <label class="text-capitalize">{{pokeType}}</label><br/>
				<strong>Height:</strong> {{pokeHeight}}<br/>
				<strong>Weight:</strong> {{pokeWeight}}<br/>
				<strong>Some moves:</strong> {{pokeMoves}}<br/>
				</div>
				<div id="blueButtons1">
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[0]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[0]}}</label>
						</p>
					</div>
				</div>
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[1]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[1]}}</label>
						</p>
					</div>
				</div>
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[2]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[2]}}</label>
						</p>
					</div>
				</div>
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[3]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[3]}}</label>
						</p>
					</div>
				</div>
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[4]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[4]}}</label>
						</p>
					</div>
				</div>
				</div>
				...
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[5]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[5]}}</label>
						</p>
					</div>
				</div>
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[6]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[6]}}</label>
						</p>
					</div>
				</div>
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[7]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[7]}}</label>
						</p>
					</div>
				</div>
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[8]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[8]}}</label>
						</p>
					</div>
				</div>
				<div class="blueButton">
					<div class="justify-content-center align-items-center">
						<p class="text-light" style="line-height: normal;">
							<label class="text-uppercase" style="font-size: 5px;">{{pokeStatNames[9]}}</label><br/>
							<label style="font-size: 10px;">{{pokeStats[9]}}</label>
						</p>
					</div>
				</div>
				</div>
...
export default {
	...
	data() {
		return {
			...
			pokeName: '?',
			pokeType: '?',
			pokeImg: 'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmedia.istockphoto.com%2Fphotos%2Fquestion-mark-interrogation-point-3d-red-icon-symbol-punctuation-mark-picture-id871641374%3Fk%3D6%26m%3D871641374%26s%3D612x612%26w%3D0%26h%3DE4JPR_BzGJejKuJjpaCFqHfC4_P2PiIqsSy0lWtCof0%3D&f=1&nofb=1',
			pokeHeight: '?',
			pokeWeight: '?',
			pokeStatNames: ['','','','','','','','','',''],
			pokeStats: ['','','','','','','','','',''],
	...
	methods: {
		async get() {
			let namep = document.getElementById('fname');
			await axios.get('https://pokeapi.co/api/v2/pokemon/' + namep.value)
				.then(response => {
					...
					this.pokeWeight = response.data.weight + ' lbs.';

					var i = 0;
					var statNames = this.pokeStatNames;
					var stats = this.pokeStats;
					response.data.stats.forEach(function(item){
						statNames[i] = item.stat.name;
						stats[i] = item.base_stat;
						i++;
					});
					this.pokeStatNames = statNames;
					this.pokeStats = stats;

					var j = 0;
					var moves = '';
					for (const item of response.data.moves){
						if (j == 5) { 
							break; 
						}
						if (j == 0) {
